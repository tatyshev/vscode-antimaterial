...
module.exports = {
  ...
  'editorGroupHeader.tabsBackground':            darken(BACKGROUND, 2),
  ...
  'editor.selectionBackground':                  lighten(BACKGROUND, 9),
  ...
  'tab.inactiveBackground':                      darken(BACKGROUND, 2),
  'tab.unfocusedActiveForeground':               darken(FOREGROUND, 20),
  'tab.border':                                  darken(BACKGROUND, 6),

  // StatusBar

  'statusBar.background':                        darken(BACKGROUND, 2),
  ...
  'statusBar.debuggingBackground':               darken(BACKGROUND, 2),
  'statusBar.debuggingForeground':               lighten(FOREGROUND, 20),
  'statusBar.noFolderBackground':                darken(BACKGROUND, 2),
  'statusBar.noFolderForeground':                darken(FOREGROUND, 15),

  // ActivityBar

  'activityBar.background':                      darken(BACKGROUND, 2),
  ...
  'peekViewTitle.background':                    darken(BACKGROUND, 2),
  ...
  'gitDecoration.modifiedResourceForeground':    '#d9cf77',
  'gitDecoration.deletedResourceForeground':     '#e56796',
  'gitDecoration.conflictingResourceForeground': '#b891ff',
  'gitDecoration.untrackedResourceForeground':   '#bde371',
